...
The density profile of stream stars around a gap formed through a gravitational perturbation encodes properties of the perturber (mass and density), the geometry of the encounter (angle, impact parameter, and relative velocity), and the time of the encounter (e.g., Erkal \& Belokurov 2015).
...
Figure~1 (top middle) shows the signal-to-noise of the stream from photometric filtering in the $g-i$ vs. $g$ CMD for 3 survey limiting magnitudes: PS1 $g \sim 22.5$, Megacam $g \sim 24$, and the proposed HSC observations $g \sim 25.5$.
The expected signal-to-noise of the stream is a factor of $\approx 1.6$ larger than the previous Megacam survey.

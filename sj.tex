...
% \pagestyle{fancy}
% \fancyhead{}
% \lfoot{\it \color{grey}{Adrian M. Price-Whelan -- Previous and Current Research}}
% \rfoot{\color{grey}{\thepage}}
% \cfoot{}
% %\rfoot{\it \color{grey}{Previous and Current Research}}
% \renewcommand{\headrulewidth}{0pt}

\apwtitle{Deep optical imaging of the Palomar 5 and GD-1 stellar streams with HSC}
\date{}
